...
public class CalculatorUTM : MonoBehaviour
{
    public double latitude_0 = 0.0, longitude_0 = 0.0;
    public double latitude_1 = 0.0, longitude_1 = 0.0;
    ...
    void Start()
    {
        ...
        Debug.Log("Result: " + "X = " + (res_0[1] - res_1[1]) + ", Z = " + (res_0[0] - res_1[0]));
    ...
    public double[] calculateUTM(double latitude, double longitude)
    {
        ...
        X = K_1 + K_2 * Math.Pow(p, 2) + K_3 * Math.Pow(p, 4);
